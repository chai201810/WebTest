...
public class AutoGenerateTest {
	...
	private static String className="AccountManageExternalBalanceDetailQueryPage";
	private static String locatorName="POP_Loc_AccountManageExternalBalanceDetailQuery";
