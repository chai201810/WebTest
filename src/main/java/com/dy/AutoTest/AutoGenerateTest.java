...
public class AutoGenerateTest {
	...
	private static String className="AccountManageAccountingEntryMaintainPage";
	private static String locatorName="POP_Loc_AccountManageAccountingEntryMaintain";
