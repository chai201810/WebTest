...
public class AutoGenerateTest {
	...
	private static String className="AccountManageOnlineInternalAccountPaymentQueryPage";
	private static String locatorName="POP_Loc_AccountManageOnlineInternalAccountPaymentQuery";
