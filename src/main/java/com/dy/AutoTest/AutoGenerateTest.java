...
public class AutoGenerateTest {
	...
	private static String className="AccountManageInnerAccountBalanceQueryPage";
	private static String locatorName="POP_Loc_AccountManageInnerAccountBalanceQuery";
