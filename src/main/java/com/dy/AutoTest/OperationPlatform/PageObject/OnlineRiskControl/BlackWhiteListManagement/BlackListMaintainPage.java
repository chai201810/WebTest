...
public class BlackListMaintainPage extends SuperPage implements IQuery{
	public BlackListMaintainPage(WebDriver driver) {
		super(driver);
		du.loadLocator("POP_Loc_BlackWhiteListManagement_BlackListMaintain");
	}
...
/****************************Auto Generate******************************/
	...
	//添加_个人姓名
	public void setAdd_PersonalName(String value) {
		du.what("Add_PersonalName").clear();
		du.what("Add_PersonalName").sendKeys(value);
	}
	public String getAdd_PersonalName() {
		return du.what("Add_PersonalName").getAttribute("value");
	}
	//添加_个人证件类型
	/**
	 * @param value
	 ...
	 * 	value="00" : 身份证
		...
		value="07" : 护照
		value="11" : 其他
		value="06" : 台湾居民来往大陆通行证
		value="03" : 军人身份证
		value="05" : 港、澳居民往来内地通行证
	 * 
	 */
	public void selectAdd_PersonalIDType(String value) {
		du.whatSelect("Add_PersonalIDType").selectByValue(value);
	}
	//添加_个人证件号码
	public void setAdd_PersonalID(String value) {
		du.what("Add_PersonalID").clear();
		du.what("Add_PersonalID").sendKeys(value);
	}
	public String getAdd_PersonalID() {
		return du.what("Add_PersonalID").getAttribute("value");
	}
	//添加_银行账户名
	public void setAdd_BankAccountName(String value) {
		du.what("Add_BankAccountName").clear();
		du.what("Add_BankAccountName").sendKeys(value);
	}
	public String getAdd_BankAccountName() {
		return du.what("Add_BankAccountName").getAttribute("value");
	}
	//添加_银行账号
	public void setAdd_BankAccountNO(String value) {
		du.what("Add_BankAccountNO").clear();
		du.what("Add_BankAccountNO").sendKeys(value);
	}
	public String getAdd_BankAccountNO() {
		return du.what("Add_BankAccountNO").getAttribute("value");
	}
	//添加_加入原因
