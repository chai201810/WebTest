...
public class LimitWarningPage extends SuperPage implements IQuery{
	public LimitWarningPage(WebDriver driver) {
		super(driver);
		du.loadLocator("POP_Loc_RiskControlWarning_LimitWarning");
	}
