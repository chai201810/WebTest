...
public class TradeClearingManagementQueryPage extends SuperPage
		implements IQuery{
	
	public TradeClearingManagementQueryPage(WebDriver driver) {
		super(driver);
		du.loadLocator("POP_Loc_SettlementManagement_TradeClearingManagementQuery");
	}
