...
public class OperBusiness {
	...
	private OperDao operDaoImpl;
	
	public OperBusiness(OperDao operDaoImpl) {
		this.operDaoImpl=operDaoImpl;
	}
	
	public String getPOPLoginSMS(String operMobileNo) {
		String sms ="";
		String VAL_LST = operDaoImpl.getPOPLoginVAL_LST(operMobileNo);
